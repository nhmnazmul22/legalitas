...
const Regulation = () => {
  return (
    <section className="bg-primary/10 py-15">
      <div className="container mt-10">
        <SectionHeading
          ...
          subTitle="Terlengkap"
        />
        <div className="mt-14 bg-white shadow-md rounded-md py-10 px-5">
          ...
          <MainButton
            ...
            className="mt-10 mx-auto w-[280px] h-[70px] text-base lg:text-lg"
          />
        </div>
      </div>
    </section>
