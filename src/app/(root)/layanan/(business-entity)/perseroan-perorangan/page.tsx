          ...
          <div className="max-w-3xl">
            <Breadcrumb>
              <BreadcrumbList className="font-semibold">
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>PT Perorangan</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
            <div className="mt-10">
              ...
              <p className="text-base md:text-lg mb-2 leading-[30px] md:leading-[36px]">
                ...
                <span className="secondary-hero-banner px-2 py-1 rounded-full text-white text-sm inline-block mx-1">
                  VOUCHER DISKON 10%
                </span>
            ...
            <div className="mt-10">
              <Tabs defaultValue="pengantar" className="w-full">
                ...
                <TabsContent value="pengantar">
                  ...
                  <LegalBasis />
                  <Process />
                  <Condition isSingleBlog={true} />
                  <Pricing isOtherService={false} />
                  <Faq />
                  <Quiz />
                  <BankPartner />
                  <Review />
